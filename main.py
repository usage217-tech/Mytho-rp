...
async def handle_manifest(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        char_video = data.get('ai_video') # NEW: Extract Video URL
        ...
        system_prompt = (
            f"You are playing in a adult Explicit roleplay as {char_name}.\n"
            ...
            "- Real speech: um, like, …, humph, stutters, moans, raw dirty explicit words that fit.\n"
        ...
        # --- NEW SEQUENCE: GIF -> IMAGE -> TEXT ---
        
        # 1. Send Animated GIF/MP4 (If available)
        if char_video:
            try:
        ...
        # 2. Send Static Character Photo (If available)
